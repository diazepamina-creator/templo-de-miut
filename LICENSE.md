...
**EL TEMPLO DE MIUT**
Manipulativo de divisibilidad, primos, mcd y mcm para 1.º y 2.º de ESO
...
> Asensio, A. (2026). *El templo de Miut: manipulativo de divisibilidad,
> primos, mcd y mcm para 1.º y 2.º de ESO* [Aplicación web]. CC BY-NC-SA 4.0.

## Tipografías

La aplicación carga **Rokkitt**, **Space Mono** y **Atkinson Hyperlegible**
desde Google Fonts, todas bajo la SIL Open Font License 1.1 y propiedad de sus
respectivos autores. Sin conexión, el navegador usa las del sistema y todo
sigue funcionando.
